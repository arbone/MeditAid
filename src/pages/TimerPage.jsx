...
const TimerPage = () => {
  ...
  return (
    <div className="timer-page">
      ...
      <button className="credits-button" onClick={() => navigate('/credits')}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="credits-icon">
